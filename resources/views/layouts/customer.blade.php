...
<header>
  <div class="wrapper">
    <nav class="fixed-top">
      ...
      <div class="content">
      <div class="logo"><a href="/Customer/home">ME<span style="color: #E30613;">RS</span></a></div>
        <ul class="links">
          <li><a href="/Customer/home">Home</a></li>
          <li><a href="/Customer/equipmentlistings">Equipment</a></li>
          <li><a href="/Customer/wallet">Wallet</a></li>
          <li>
              <input type="checkbox" id="show-listings">
            <label for="show-listings">Orders</label>
            <ul>
              <li><a href="/Customer/orders/waiting">Orders awaiting rental acceptance/rejection</a></li>
      				<li><a href="/Customer/orders/pending">Orders pending payment</a></li
      				<li><a href="/Customer/orders/paid">Paid Orders</a></li>
              <li><a href="/Customer/orders/rejected">Rejected Orders</a></li>
            </ul>
          </li>
          <li><a href="/Customer/rental/cart">Cart</a></li>

          <li>
            <input type="checkbox" id="show-rr"> 
            <label for="show-rr">Rates & Reviews</label>
            <ul>
              <li><a href="/Customer/owners/ratingsreviews">Owner Rates and Reviews</a></li>
              <li><a href="/Customer/owners/ratingsreviews/pending">Pending Owner Rating and Review</a></li>
              <li><a href="/Customer/my/ratingsreviews">My Rates and Reviews</a></li>
            </ul>
          </li>
      ...
      <form action="/Customer/search" class="search-box">
        @csrf
        <input type="text" name="search" placeholder="Search for Equipment..." required>
        <button type="submit" class="go-icon"><i class="fas fa-long-arrow-alt-right"></i></button>
      </form>
      @if(!isset($profile))
      <a title="View profile" href="/Customer/profile/{{$customerID}}"><img class="tbl_img" src="/img/admin.jpg"></a>
      @else
      <a title="View profile" href="/Customer/profile/{{$customerID}}"><img class="tbl_img" src="/img/{{$profile}}"></a>
      @endif
    </nav>
  </div>
</header>
