...
<!-- Blade directive used to call name the body as a section that can be 
    ...
    @php
    $user = auth()->user();
        $customerID = $user->id; //Gets ID of signed in user
        $customerfname = $user->fname;
        $customerlname = $user->lname;
    ...
    <section class="home" id="home">
      <div class="container">
        <div class="row min-vh-40 align-items-center">
          <div class="col-md-6">
          <div class="content">
            <h3>Welcome {{$customerfname}} {{$customerlname}}</h3>
            ...
            <a href="/Customer/equipmentlistings"><button class="btn" style="background-color:#E30613; color:white;">Explore equipment offered</button></a>
          </div>
          </div>
        </div>
      </div>
      ...
      <div class="container">
        <div class="row align-items-center">
          ...
          <div class="col-md-6 content">
            ...
            <a href="/Customer/equipmentlistings"><button class="btn" style="background-color:#E30613; color:white;">Start renting now</button></a>
          </div>
