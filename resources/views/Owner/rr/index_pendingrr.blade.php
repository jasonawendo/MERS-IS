...
<div class="info">
      ...
      <div class="col-md-12">
        <center>
			...
			<h5 class="desc">These are the Ratings and Reviews you need to do for your past Customers</h5>
		</center>
      			...
      			<tbody>
					@foreach($rentals as $rental)
						...
						<tr>
							...
							<td>
								<a class="btn btn-info" href="/Owner/customers/ratingsreviews/{{$rental -> customerID}}">View Customer details</a>
								<a style="color:white;" class="btn btn-warning" href="/Owner/customers/ratingsreviews/create/{{$rental -> customerID}}/{{$rental -> rentalID}}">Give Rating & Review</a>
							</td>
						</tr>
					@endforeach
            	</tbody>
